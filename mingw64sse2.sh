...
# gcc 4.4
extracflags="-Ofast -msse2 -falign-functions=16 -falign-jumps=16 -falign-loops=16 -falign-labels=16 -mno-vzeroupper -std=gnu11 -s" # -funroll-loops -fvariable-expansion-in-unroller -fbranch-target-load-optimize2 -fsched2-use-superblocks -falign-loops=16 -falign-functions=16 -falign-jumps=16 -falign-labels=16"
